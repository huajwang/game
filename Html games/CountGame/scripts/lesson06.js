...
(lib.mountains = function(mode,startPosition,loop) {
	...
	this.shape.setTransform(899,77.8);

	this.timeline.addTween(cjs.Tween.get(this.shape).wait(1));

}).prototype = p = new cjs.MovieClip();
p.nominalBounds = new cjs.Rectangle(99,0,1600,155.6);
...
(lib.Sun = function(mode,startPosition,loop) {
	...
	// 图层_1
	this.instance = new lib.补间4();
	this.instance.parent = this;
	this.instance.filters = [new cjs.BlurFilter(10, 10, 1)];
	this.instance.cache(-52,-52,104,104);

	this.timeline.addTween(cjs.Tween.get(this.instance).to({scaleX:1.14,scaleY:1.14,y:0.5},47).to({scaleX:1,scaleY:1,y:0},24).wait(1));

}).prototype = p = new cjs.MovieClip();
p.nominalBounds = new cjs.Rectangle(-60,-60,128,128);


(lib.Landscape = function(mode,startPosition,loop) {
	this.initialize(mode,startPosition,loop,{});

	// 图层_3
	this.instance = new lib.mountains("synched",0);
	this.instance.parent = this;
	this.instance.setTransform(1011.5,-77.7,1.125,1,0,0,0,899.1,77.8);

	this.timeline.addTween(cjs.Tween.get(this.instance).to({regX:899,x:211.5},30).wait(1));

	// 图层_4
	this.instance_1 = new lib.mountains("synched",0);
	this.instance_1.parent = this;
	this.instance_1.setTransform(1123.8,-99.9,1.25,1.286,0,0,0,899,77.8);

	this.timeline.addTween(cjs.Tween.get(this.instance_1).to({x:123.8},30).wait(1));

}).prototype = p = new cjs.MovieClip();
p.nominalBounds = new cjs.Rectangle(111.4,-200,2012.4,200);
...
// stage content:
(lib._06Start = function(mode,startPosition,loop) {
	this.initialize(mode,startPosition,loop,{});

	// bird
	this.instance = new lib.bird_flight();
	this.instance.parent = this;
	this.instance.setTransform(308.9,184,0.318,0.318,0,0,0,342.6,342.9);
	...
	this.instance_1.parent = this;
	this.instance_1.setTransform(655,123.1);

	this.instance_2 = new lib.Landscape();
	this.instance_2.parent = this;
	this.instance_2.setTransform(986.9,300,1,1,0,0,0,1111.4,-100);
	...
	this.instance_3.parent = this;
	this.instance_3.setTransform(400,200);

	this.timeline.addTween(cjs.Tween.get(this.instance_3).wait(1));

}).prototype = p = new cjs.MovieClip();
p.nominalBounds = new cjs.Rectangle(386.9,200,2012.4,400);
// library properties:
lib.properties = {
	id: 'C856B99F64304CE293CF1623197346DF',
	width: 800,
	height: 400,
	fps: 30,
	color: "#FFFFFF",
...
an.compositions['C856B99F64304CE293CF1623197346DF'] = {
